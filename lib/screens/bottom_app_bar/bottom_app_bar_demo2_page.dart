...
class BottomAppBarDemo2Page extends StatefulWidget {
  const BottomAppBarDemo2Page({super.key});

  @override
  State<BottomAppBarDemo2Page> createState() =>
      _BottomAppBarDemo2PageState();
}

class _BottomAppBarDemo2PageState
    extends State<BottomAppBarDemo2Page> {
