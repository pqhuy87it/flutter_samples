...
class CarouselViewExamplePage extends StatefulWidget {
  static String routeName = 'basics/carousel_view_example';

  const CarouselViewExamplePage({super.key});

  @override
  State<CarouselViewExamplePage> createState() =>
      _CarouselViewExamplePageState();
}

class _CarouselViewExamplePageState extends State<CarouselViewExamplePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Carousel View Example')),
      body: ListView(
        children: <Widget>[
          ConstrainedBox(
