...
class PageViewBasicPage extends StatefulWidget {
  const PageViewBasicPage({super.key});

  static String routeName = 'basics/pageview_example';

  @override
  State<PageViewBasicPage> createState() => _PageviewBasicPageState();
}

class _PageviewBasicPageState extends State<PageViewBasicPage>
