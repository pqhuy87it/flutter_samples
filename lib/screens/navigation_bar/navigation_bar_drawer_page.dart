...
class NavigationBarDrawerPage extends StatefulWidget {
  const NavigationBarDrawerPage({super.key});

  @override
  State<NavigationBarDrawerPage> createState() => _NavigationBarDrawerPageState();
}

class _NavigationBarDrawerPageState extends State<NavigationBarDrawerPage> {
  ...
  void didChangeDependencies() {
    ...
    showNavigationDrawer = MediaQuery.of(context).size.width >= 300;
  }
