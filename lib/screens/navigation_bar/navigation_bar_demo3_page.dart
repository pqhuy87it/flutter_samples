...
class NavigationBarDemo3Page extends StatefulWidget {
  const NavigationBarDemo3Page({super.key});

  @override
  State<NavigationBarDemo3Page> createState() => _NavigationBarDemo3PageState();
}

class _NavigationBarDemo3PageState extends State<NavigationBarDemo3Page>
    with TickerProviderStateMixin<NavigationBarDemo3Page> {
